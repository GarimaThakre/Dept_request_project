...
/**
 * Servlet implementation class UpdateTable1
 */
@WebServlet("/UpdateTable1")
public class UpdateTable1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query1 = "update finance set approvedDate=?,status=?, approvedBy=? where sno=? ";
